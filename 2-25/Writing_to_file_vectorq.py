...
vectorq_practicefile.write("set dendir = /Users/brownscholar/desktop/Internship/atlantic_data/dens/\n")
...
vectorq_practicefile.write("set filedh =  {$dhdir}/geopotential" +date+ ".txt\n")
vectorq_practicefile.write("set filest =  {$dendir}/density"+date+ ".txt\n")
