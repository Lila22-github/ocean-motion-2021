...
decision = "Should I go to Papa's zoom meeting about tractor safety?"

# Pick three factors that affect your decision and write them as strings
factor_1 = "Do I have time?"
factor_2 = "Will I use this knowledge?"
factor_3 = "Will it change my perspective on tractors?"
...
# etc:
weights = np.array([2, 5, 6])#your code here
...
factor_values = np.array([0, 0, 1])# your code here
